...
const projects = [
  ...
  // Swiftly
  {
    ...
    timeline: "Apr `22",
    description:
      "A project manager tool built using React Typescript and Tailwind, as part of Global Digital Corps training - WD301 Course Capstone Project. Backend deployed on heroku, and frontend deployed on netlify.",
