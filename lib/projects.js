...
import { platforms, db, iot, frameworks, langs, otherTools } from "./skills";
...
const projects = [
  ...
  // OsumPi
  {
    ...
    otherLinks: [],
    tags: [langs.Dart, frameworks.Flutter, iot.MQTT],
  },
  // Swiftly
  {
    title: "Swiftly - Project Manager | React + Tailwind",
    image: SwiftlyBG,
  ...
  // Javascript Training
  {
    title: "Personal website with Martial Arts game | Javascript + Tailwind",
    image: MartialArtsBG,
    ...
    tags: [langs.Javascript, langs.HTML, frameworks.Tailwind, iot.HTTP],
  },
  // VITCC Electrical Issues
  {
    ...
    tags: [langs.Dart, frameworks.Flutter, db.Firestore, platforms.GCP],
  },
  // Standalone 3D Position Sensor
  {
    ...
    tags: [langs.Cpp, iot.MQTT, iot.ESP01, iot.arduinoUno],
  },
  // AUXPIS BPS
  {
    ...
    tags: [langs.Cpp, iot.MQTT, iot.ESP8266, iot.arduinoMini],
  },
  // Smart Junction
  {
